document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ar: {
      ...
      'services-description': 'تتشرف شركة PDCA لمكافحة الآفات بتقديم أفضل خدمات مكافحة الآفات لكم. وذلك لأننا نمتلك أفضل فريق متخصص ومجهز جيدًا يستخدم أحدث الأساليب لمكافحة جميع أنواع الحشرات.',
      'service-rodent-title': 'مكافحة القوارض',
      'service-rodent-description': 'القضاء الكامل على القوارض باستخدام علاجات متخصصة',
      'service-flying-title': 'مكافحة الحشرات الطائرة',
      'service-flying-description': 'مكافحة فعالة للحشرات الطائرة لحماية المواد الغذائية',
      'service-crawling-title': 'مكافحة الحشرات الزاحفة',
      'service-crawling-description': 'مكافحة شاملة للحشرات الزاحفة للأماكن الداخلية والخارجية',
      'service-stray-title': 'مكافحة الحيوانات الضالة',
      'service-stray-description': 'علاجات مُستهدفة لمختلف أنواع الحيوانات الضالة',
    ...
    en: {
      ...
      'services-description': 'PDCA Pest Control Company is honored to provide you with the best pest control services. This is because we have the best specialized and well-equipped team using the latest methods to combat all types of insects.',
      'service-rodent-title': 'Rodent Control',
      'service-rodent-description': 'Complete rodent eradication using specialized treatments',
      'service-flying-title': 'Flying Insect Control',
      'service-flying-description': 'Effective control of flying insects to protect food',
      'service-crawling-title': 'Crawling Insect Control',
      'service-crawling-description': 'Comprehensive crawling insect control for indoor and outdoor areas',
      'service-stray-title': 'Stray Animal Control',
      'service-stray-description': 'Targeted treatments for various stray animal species',
